...
export default function DashboardSidebar({ user }: DashboardSidebarProps) {
  ...
  function SidebarContent() {
    return (
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-2.5 px-6 h-14 border-b border-white/5 shrink-0">
          <span className="relative flex items-center justify-center w-6 h-6">
            <span className="absolute inset-0 rounded-sm bg-gradient-to-br from-[#c9a84c] to-[#e8c97a]" />
            <span className="relative text-[#0a0a0f] font-black text-xs leading-none">
              P
            </span>
          </span>
          <span
            className="text-white/50 font-light tracking-[0.25em] uppercase text-xs"
            style={{
  ...
  return (
    <>
      <aside className="hidden md:flex fixed left-0 top-0 bottom-0 w-64 flex-col bg-[#0a0a0f] border-r border-white/5 z-40">
        <SidebarContent />
      </aside>
      <button
